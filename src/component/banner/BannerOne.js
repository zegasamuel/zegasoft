                    ...
                    <div className="col-lg-6">
                        <div className="banner-content">
                            <AnimationOnScroll animateIn="fadeInUp" animateOnce={true} delay={100}>
                                <h1 className="title">Connect to the world now!</h1>
                                <span className="subtitle">Full service Digital Transformation solutions provider specializing in e-business.</span>
