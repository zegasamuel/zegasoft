                        ...
                        <div className="col-lg-6 offset-xl-1">
                            <div className="why-choose-us">
                                <div className="section-heading heading-left">
                                    ...
                                    <p>Digital technology has made our world more transparent and interconnected, posing new challenges and opportunities for every business.
                                ...
                                <Accordion defaultActiveKey="1">
                                    <Accordion.Item eventKey="1">
                                        ...
                                        <Accordion.Body>
                                            We focus in three main strategies that focus on technology innovations, product variation, and creating lasting impacts for its partners.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="2">
                                        <Accordion.Header><FaCode /> Design</Accordion.Header>
                                        <Accordion.Body>
                                            For the design we put user friendly first then supported with simplicity and modern design. 
                                        </Accordion.Body>
                                    </Accordion.Item>
                                    <Accordion.Item eventKey="3">
                                        <Accordion.Header><FaGlobe /> Development</Accordion.Header>
                                        <Accordion.Body>
                                            Support client requirement with effective solutions with the most suitable technology.
                                        </Accordion.Body>
                                    </Accordion.Item>
                                </Accordion>
                            </div>
