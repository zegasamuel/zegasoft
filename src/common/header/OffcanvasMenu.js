...
import { FaFacebookF, FaTwitter, FaLinkedinIn, FaBehance, FaPhone,FaInstagram, FaFax } from "react-icons/fa";
                        ...
                        <div className="contact-info-wrap">
                            <div className="contact-inner">
                                ...
                                <address className="address">
                                    ...
                                    <a href="tel:+6282273537801" className="tel"><FaPhone /> +62 822 7353 7801</a>
                            ...
                            <div className="contact-inner">
                                ...
                                <div className="contact-social-share">
                                    <ul className="social-share list-unstyled">
                                        ...
                                        <li>
                                            <a href="https://www.instagram.com/zegasoft/"><FaInstagram /></a>
                                        </li>
                                        {/* <li>
                                            <a href="https://www.behance.net/"><FaBehance /></a>
                                        </li> */}
                                        <li>
                                            <a href="https://www.linkedin.com/company/zegasoft/"><FaLinkedinIn /></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
